codeunit 50103 "Validate Events"
{
    [EventSubscriber(ObjectType::Table, Database::"Validate Table", 'OnBeforeValidateEvent', 'Validate This', true, true)]
    local procedure MyProcedure1(var Rec: Record "Validate Table"; var xRec: Record "Validate Table"; CurrFieldNo: Integer)
    begin
    ...
    begin
        Message('OnAfterValidateEvent Page Event Trigger');
        Rec."Validate This" := 'OnAfterValidateEvent Page Event Trigger';
